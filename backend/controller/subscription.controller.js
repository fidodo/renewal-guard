...
//       },
//       billingDate: {
//         startDate: new Date(billingDate.startDate),
//         nextBillingDate: new Date(billingDate.nextBillingDate),
//       },
//       status: "active",
...
//       const workflowResult = await workflowClient.trigger({
//         url: `${SERVER_URL}/api/v1/workflows/subscription/reminder`,
//         body: { subscriptionId: savedSubscription._id },
//         headers: { "Content-Type": "application/json" },
//         retries: 0,
//       });
//       workflowRunId = workflowResult.workflowRunId;
...
//         $lte: upcomingDate,
//       },
//     }).sort({ "billingDate.nextBillingDate": 1 });
...
//       if (updateData.billingDate.startDate) {
//         updateData.billingDate.startDate = new Date(
//           updateData.billingDate.startDate
//         );
//       }
//       if (updateData.billingDate.nextBillingDate) {
//         updateData.billingDate.nextBillingDate = new Date(
//           updateData.billingDate.nextBillingDate
//         );
//       }
//     }
